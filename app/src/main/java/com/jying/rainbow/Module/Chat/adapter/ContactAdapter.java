...
import com.jying.rainbow.Module.Chat.adapter.base.BaseRecyclerAdapter;
import com.jying.rainbow.Module.Chat.adapter.base.BaseRecyclerHolder;
...
public class ContactAdapter extends BaseRecyclerAdapter<Friend> {
    ...
    public void bindView(BaseRecyclerHolder holder, Friend friend, int position) {
        if (holder.layoutId == R.layout.item_contact) {
            ...
            //好友名称
            holder.setText(R.id.tv_recent_name, user == null ? "佚名" : user.getUsername());
